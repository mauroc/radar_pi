...
#ifndef _RAYMARINE_DIGITAL_RECEIVE_H_
#define _RAYMARINE_DIGITAL_RECEIVE_H_
...
//
// An intermediary class that implements the receive part of a Raymarine Digital radar
//

class RaymarineDigitalReceive : public RadarReceive {
 public:
  RaymarineDigitalReceive(radar_pi *pi, RadarInfo *ri, NetworkAddress reportAddr) : RadarReceive(pi, ri) {
    ...
    // TODO m_send_socket = GetLocalhostSendTCPSocket(m_receive_socket);
...
#endif /* _RAYMARINE_DIGITAL_RECEIVE_H_ */
