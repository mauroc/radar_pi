...
#ifndef _RAYMARINE_DIGITAL_CONTROL_H_
#define _RAYMARINE_DIGITAL_CONTROL_H_
...
class RaymarineDigitalControl : public RadarControl {
 public:
  RaymarineDigitalControl();
  ~RaymarineDigitalControl();
...
#endif /* _RAYMARINE_DIGITAL_CONTROL_H_ */
